...
export default function Footer() {
  ...
  return (
    <footer className="mt-40 py-4 md:mt-0 md:pt-16 md:pb-6 relative z-50" role="contentinfo">
      {/* Back to top */}
      ...
      {/* Bottom strip */}
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-2 md:pt-6 flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 md:gap-4 text-center md:text-left">
